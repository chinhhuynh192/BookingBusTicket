...
public class SearchTrip extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String seatQuantityStr = request.getParameter("quantity");

            int seatQuantityInt = ConvertUtil.convert(seatQuantityStr);
            ...
            request.setAttribute("seatquantity", seatQuantityInt);
