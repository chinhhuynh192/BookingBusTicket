            ...
            <section class="border border-2 shadow rounded p-1 mb-3 bg-white">
                <form id="searchForm" method="get" action="searchTrip">
                    <div class="search-content-items d-flex flex-column rounded p-2 ">
                        <div class="my-3 d-flex mx-2 fs-5">
                            <div class="form-check">
                                <input class="form-check-input mb-2" type="radio" name="booking-type" id="one-way-type"
                                       checked/>
                                <label for="one-way-type" class="form-check-label mb-1">Một chiều</label>
                            </div>
                            <div class="form-check mx-4">
                                <input class="form-check-input mb-2" type="radio" name="booking-type"
                                       id="two-way-type"/>
                                <label for="two-way-type" class="form-check-label mb-1">Khứ hồi</label>
                            </div>
                        </div>
                        <div class="d-flex justify-content-around">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" placeholder="Tp HCM" name="fromlocation"
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" placeholder="Hà nội" class="form-control" name="tolocation"
                            ...
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" placeholder="Số vé" name="quantity"
